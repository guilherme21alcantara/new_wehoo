              ...
              <UncontrolledDropdown className='email-info-dropup'>
                ...
                <DropdownMenu>
                  <Table className='font-small-3' size='sm' borderless>
                    <tbody>
                      <tr>
                        <td className='text-right text-muted align-top'>De:</td>
                        <td>{obj.from.email}</td>
                      </tr>
                      <tr>
                        <td className='text-right text-muted align-top'>Para:</td>
                        <td>{obj.to[0].email}</td>
                      </tr>
                      <tr>
                        <td className='text-right text-muted align-top'>Data:</td>
                        <td>
          ...
          <CardFooter>
            <div className='mail-attachments'>
              <div className='d-flex align-items-center mb-1'>
                <Paperclip size={16} />
                <h5 className='font-weight-bolder text-body mb-0 ml-50'>{obj.attachments.length} Anexo </h5>
              </div>
                  ...
                  <Row className='mb-1'>
                    <Col sm='12'>
                      <a className='font-weight-bold' href='/' onClick={handleShowReplies}>
                        Ver {mail.replies.length} Mensagens Anteriores
                      </a>
                    </Col>
                  </Row>
                ) : null}
