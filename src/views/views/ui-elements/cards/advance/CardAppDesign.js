  ...
  return (
    <Card className='card-app-design'>
      <CardBody>
        ...
        <CardTitle className='mt-1 mb-75'>Design do App</CardTitle>
        <CardText className='font-small-2 mb-2'>
          Você pode encontrar apenas postagens e frases relacionadas a IOS, como design de apps do ipad e iphone
        </CardText>
        <div className='design-group mb-2 pt-50'>
          <h6 className='section-label'>Time</h6>
        ...
        <div className='design-group pt-25'>
          <h6 className='section-label'>Membros</h6>
