      ...
      <CardBody>
        <div className='meetup-header d-flex align-items-center'>
          ...
          <div className='my-auto'>
            ...
            <CardText className='mb-0'>Encontre Desenvolvedores populares no mundo todo</CardText>
          </div>
        </div>
        <Media>
          <Avatar color='light-primary' className='rounded mr-1' icon={<Calendar size={18} />} />
          <Media body>
            <h6 className='mb-0'>Sáb, 25 de maio, 2020</h6>
            <small>10:00 as 18:00</small>
          </Media>
        </Media>
