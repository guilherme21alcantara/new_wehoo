...
const CardBrowserState = ({ colors, trackBgColor }) => {
  ...
  return (
    <Card className='card-browser-states'>
      <CardHeader>
        <div>
          <CardTitle tag='h4'>Estados do Navegador</CardTitle>
          <CardText className='font-small-2'>Contador August 2020</CardText>
        </div>
        <UncontrolledDropdown className='chart-dropdown'>
          ...
          <DropdownMenu right>
            <DropdownItem className='w-100'>Últimos 28 Days</DropdownItem>
            <DropdownItem className='w-100'>Últimos Month</DropdownItem>
            <DropdownItem className='w-100'>Últimos Year</DropdownItem>
          </DropdownMenu>
        </UncontrolledDropdown>
      </CardHeader>
