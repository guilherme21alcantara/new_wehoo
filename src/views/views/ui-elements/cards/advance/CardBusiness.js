  ...
  return (
    <Card className='business-card'>
      <CardHeader className='pb-1'>
        <CardTitle tag='h4'>Para Tubarões de Negócios</CardTitle>
        <MoreVertical size={18} className='cursor-pointer' />
      </CardHeader>
      <CardBody>
        <CardText>Aqui, eu foco em um variedade de itens e recursos que usamos sem dá-los</CardText>
        <h6 className='mb-75'>O preço base é $130</h6>
