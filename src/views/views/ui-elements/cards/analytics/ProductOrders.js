...
const ProductOrders = props => {
  ...
  return data !== null ? (
    <Card>
      <CardHeader>
        <CardTitle tag='h4'>Pedidos de produtos</CardTitle>
      ...
      <CardBody>
        ...
        <div className='d-flex justify-content-between mb-1'>
          <div className='d-flex align-items-center'>
            ...
            <span className='font-weight-bold ml-75'>Finalizado</span>
          </div>
        ...
        <div className='d-flex justify-content-between mb-1'>
          <div className='d-flex align-items-center'>
            ...
            <span className='font-weight-bold ml-75'>Pendente</span>
          </div>
        ...
        <div className='d-flex justify-content-between'>
          <div className='d-flex align-items-center'>
            ...
            <span className='font-weight-bold ml-75'>Rejeitado</span>
          </div>
