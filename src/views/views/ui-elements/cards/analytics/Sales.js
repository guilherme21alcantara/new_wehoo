    ...
    <Card>
      <CardHeader className='d-flex justify-content-between align-items-start pb-1'>
        <div>
          ...
          <CardText>Últimos 6 mêses</CardText>
        </div>
        ...
        <UncontrolledDropdown className='chart-dropdown'>
          ...
          <DropdownMenu right>
            <DropdownItem className='w-100'>Últimos 28 Dias</DropdownItem>
            <DropdownItem className='w-100'>Último Mês</DropdownItem>
            <DropdownItem className='w-100'>Último Ano</DropdownItem>
          </DropdownMenu>
        </UncontrolledDropdown>
      </CardHeader>
