      ...
      <CardBody>
        <Row className='pb-50'>
          ...
          >
            <div className='session-info mb-1 mb-lg-0'>
              ...
              <CardText className='font-weight-bold mb-2'>Média de sessões</CardText>
              <h5 className='font-medium-2'>
                <span className='text-success mr-50'>{data.growth}</span>
                <span className='font-weight-normal'>vs últimos 7 dias</span>
              </h5>
            </div>
        ...
        <Row className='pt-50'>
          <Col className='mb-2' md='6' sm='12'>
            <p className='mb-50'>Meta: ${data.goal}</p>
            <Progress className='avg-session-progress mt-25' value='50' />
          </Col>
          <Col className='mb-2' md='6' sm='12'>
            <p className='mb-50'>Usuários: {kFormatter(data.users)}</p>
          ...
          <Col md='6' sm='12'>
            <p className='mb-50'>Duração: {data.duration}an</p>
